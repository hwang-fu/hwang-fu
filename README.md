...
- 「」**[wvec](https://github.com/hwang-fu/wvec)** — A **Word2Vec implementation from scratch** in Rust + Modern Fortran. BLAS/OpenMP-accelerated training, BPE tokenizer. (100% original work, v1.0.0 release)
